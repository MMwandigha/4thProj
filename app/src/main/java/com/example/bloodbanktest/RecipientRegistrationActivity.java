...
public class RecipientRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //check if user has put all the required info
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                userDatabaseRef.updateChildren(userInfo).addOnCompleteListener(task1 -> {
                                    if (task1.isSuccessful()) {
                                        ...
                                        Toast.makeText(RecipientRegistrationActivity.this, task1.getException().toString(), Toast.LENGTH_SHORT).show();
                                    }
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatabaseRef.updateChildren(newImageMap).addOnCompleteListener(task12 -> {
                                                            if (task12.isSuccessful()) {
                                                                Toast.makeText(RecipientRegistrationActivity.this, "Image URL added to database succesfully", Toast.LENGTH_SHORT).show();
                                                            } else {
                                                                Toast.makeText(RecipientRegistrationActivity.this, task12.getException().toString(), Toast.LENGTH_SHORT).show();
                                                            }
                                                        });
                                                        finish();
                                                    }
