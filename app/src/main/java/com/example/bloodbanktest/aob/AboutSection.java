...
import com.example.bloodbanktest.AdminProfile;
...
public class AboutSection extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.Previous:
                Intent intent = new Intent(AboutSection.this,FAQ.class);
            ...
            case R.id.Contact:
                Intent intent3  = new Intent(AboutSection.this, AdminProfile. class);
