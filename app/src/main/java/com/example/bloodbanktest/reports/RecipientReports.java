...
public class RecipientReports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipient_reports);
        ...
        pFile = new File(payfile, "System Recipients.pdf");
        fetchPaymentUsers();
...
//                    Log.d("Payment")
    ...
    private void createPaymentReport(List<User> paymentUsersList) throws DocumentException, FileNotFoundException {
        ...
        document.add(new Paragraph(" Recipients in the System\n\n", g));
        document.add(table);
