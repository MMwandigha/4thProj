...
public class DonorReports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_reports);
        ...
        pFile = new File(payfile, "System Donors.pdf");
        fetchPaymentUsers();
...
//                    Log.d("Payment")
    ...
    private void createPaymentReport(List<User> paymentUsersList) throws DocumentException, FileNotFoundException {
        ...
        document.add(new Paragraph(" Donors in the System\n\n", g));
        document.add(table);
